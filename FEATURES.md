...
- Show the join URL in the add-machine dialog.
- Add a report-bug button.
- Add a tool for listing templates and getting template details.
- Quick zoom takes too long to reach with the wheel — make it one click less.
- Do not hide terminal content while zooming out.
- Support custom environment variables for agent templates.
